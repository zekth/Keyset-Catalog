  ...
  <div id="render-zone">
    ...
    >
      <g class="keyboard-case">
        <rect x="440" y="-20" fill="#1f1f1f" width="1770" height="520" rx="7" ry="7" />
        <rect x="460" y="93" fill="#080808" width="1133" height="380" rx="7" ry="7" />
        <rect x="1880" y="93" fill="#080808" width="305" height="380" rx="7" ry="7" />
        <rect x="1620" y="93" fill="#080808" width="230" height="157" rx="7" ry="7" />
        <rect x="1620" y="-5" fill="#080808" width="230" height="81" rx="7" ry="7" />
        <rect x="460" y="-5" fill="#080808" width="80" height="81" rx="7" ry="7" />
        <rect x="610" y="-5" fill="#080808" width="306" height="81" rx="7" ry="7" />
        <rect x="945" y="-5" fill="#080808" width="306" height="81" rx="7" ry="7" />
        <rect x="1285" y="-5" fill="#080808" width="306" height="81" rx="7" ry="7" />
      </g>
      <g>
      ...
      <g>
        <svg x="0" y="100" height="70px" width="1000px" style="overflow:initial">
          ...
          <U1 x="1420" :data="getKeyData('KC_NLCK', 'mod', 'Num')" isMod="true" />
          <U1 x="1495" :data="getKeyData('KC_PSLS', 'mod', '%')" isMod="true" />
          <U1 x="1570" :data="getKeyData('KC_PAST', 'mod', 'X')" isMod="true" />
          <U1 x="1645" :data="getKeyData('KC_PMNS', 'mod', '-')" isMod="true" />
        </svg>
      </g>
      <g>
        <svg x="0" y="173" height="70px" width="1000px" style="overflow:initial">
          ...
          <U1 x="710" :data="getKeyData('KC_O', 'base', 'O')" />
          <U1 x="785" :data="getKeyData('KC_P', 'base', 'P')" />
          <U1 x="860" :data="getKeyData('KC_LBRC', 'base', '{', '[')" />
          <U1 x="935" :data="getKeyData('KC_RBRC', 'base', '}', ']')" />
          <U15 x="1010" :data="getKeyData('KC_BSLS', 'base', '|', '\\')" />
          <U1
            x="1160"
          ...
          <U1
            ...
            :color="'base'"
          />
          <U1 x="1420" :data="getKeyData('KC_P7', 'base', '7')" />
          <U1 x="1495" :data="getKeyData('KC_P8', 'base', '8')" />
          <U1 x="1570" :data="getKeyData('KC_P9', 'base', '9')" />
        </svg>
      </g>
      <g>
        <svg x="0" y="246" height="70px" width="1000px" style="overflow:initial">
          ...
          <U1 x="504" :data="getKeyData('KC_H', 'base', 'H')" />
          <U1 x="579" :data="getKeyData('KC_J', 'base', 'J')" />
          ...
          <U1 x="1420" :data="getKeyData('KC_P4', 'base', '4')" />
          <U1 x="1495" :data="getKeyData('KC_P5', 'base', '5')" />
          <U1 x="1570" :data="getKeyData('KC_P6', 'base', '6')" />
        </svg>
      </g>
      <g>
        <svg x="0" y="320" height="70px" width="1000px" style="overflow:initial">
